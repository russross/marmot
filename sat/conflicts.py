...
def encode_conflicts(
    ...
    """
    Encode soft conflict constraints: two sections should not be scheduled at
...
def encode_anti_conflicts(
    ...
    """
    Encode anti-conflict constraints: when the single section is scheduled,
    at least one section from the group must be scheduled at the same time.
