...
db.make_conflict('Computer Science', '3rd/4th semester classes', 100, 'maximize',
    ['CS 2420', 'CS 2450', 'CS 2810', 'CS 3005'])
db.make_conflict('Computer Science', 'grad plan: 2nd year fall', 100, 'maximize',
    ['CS 2420', 'CS 2450', 'CS 2810'])
db.make_conflict('Computer Science', 'grad plan: 2nd year spring', 100, 'maximize',
    ['CS 3005', 'CS 3520', 'SE 3200'])
db.make_conflict('Computer Science', 'grad plan: 3rd year fall', 100, 'maximize',
    ['CS 3310', 'CS 3400', 'CS 3530'])
db.make_conflict('Computer Science', 'grad plan: 3rd year spring', 100, 'maximize',
    ['CS 3510', 'CS 4307', 'CS 4550'])
db.make_conflict('Computer Science', 'grad plan: 4th year fall', 100, 'maximize',
    ['CS 4300'])
db.make_conflict('Computer Science', 'grad plan: 4th year spring', 100, 'maximize',
    ['CS 3600', 'CS 4600'])
db.make_conflict('Computer Science', 'core requirements', 99, 'maximize',
    ...
    'SE 3200'])
db.make_conflict('Computer Science', 'electives', 30, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810', 'CS 3005',
    'CS 3150', 'CS 3310', 'CS 3400', 'CS 3410', 'CS 3510', 'CS 3520', 'CS 3530', 'CS 3600',
    'CS 4300', 'CS 4307', 'CS 4320', 'CS 4550', 'CS 4600',
    'SE 3200',
...
db.make_conflict('Computer Science', 'math and science', 50, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810', 'CS 3005',
    'CS 3150', 'CS 3310', 'CS 3400', 'CS 3410', 'CS 3510', 'CS 3520', 'CS 3530', 'CS 3600',
    'CS 4300', 'CS 4307', 'CS 4320', 'CS 4550', 'CS 4600',
    'SE 3200',
...
db.make_conflict('Data Science', 'third semester', 45, 'maximize',
    ['CS 2500', 'CS 2810', 'CS 3005'])

db.make_program('Software Engineering', 'Computing')
db.make_conflict('Software Engineering', 'core requirements', 99, 'maximize',
    ...
    'SE 4200', 'SE 4600'])
db.make_conflict('Software Engineering', 'Entrepreneurial and marketing track', 45, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810',
    'CS 3150', 'CS 3310', 'CS 3510', 'CS 4307',
    'IT 1100', 'IT 2300',
    'SE 1400', 'SE 3010', 'SE 3020', 'SE 3100', 'SE 3150', 'SE 3200', 'SE 3400', 'SE 3500', 'SE 3550',
    'SE 4200', 'SE 4600'])
db.make_conflict('Software Engineering', 'DevOps track', 45, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810',
    'CS 3150', 'CS 3310', 'CS 3510', 'CS 4307',
    'IT 1100', 'IT 2300', 'IT 3110', 'IT 3300', 'IT 4200',
    'SE 1400', 'SE 3010', 'SE 3020', 'SE 3100', 'SE 3150', 'SE 3200', 'SE 3400',
    'SE 4200', 'SE 4600'])
db.make_conflict('Software Engineering', 'Application track', 45, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810',
    'CS 3150', 'CS 3310', 'CS 3500', 'CS 3510', 'CS 4307',
    'IT 1100', 'IT 2300',
    'SE 1400', 'SE 3010', 'SE 3020', 'SE 3100', 'SE 3150', 'SE 3200', 'SE 3400', 'SE 3450',
    'SE 4200', 'SE 4600'])
db.make_conflict('Software Engineering', 'Data science track', 45, 'maximize',
    ['CS 1030', 'CS 1400', 'CS 1410', 'CS 2420', 'CS 2450', 'CS 2810',
    'CS 3150', 'CS 3310', 'CS 3510', 'CS 4300', 'CS 4307', 'CS 4320',
    'IT 1100', 'IT 2300',
    'SE 1400', 'SE 3010', 'SE 3020', 'SE 3100', 'SE 3150', 'SE 3200', 'SE 3400',
    'SE 4200', 'SE 4600'])
db.make_conflict('Software Engineering', 'only need one database class', 0, 'minimize',
    ['CS 4307', 'IT 2300'])

db.make_program('Information Technology', 'Computing')
db.make_conflict('Information Technology', 'core requirements', 99, 'maximize',
...
db.make_conflict('Information Technology', 'choose two section', 60, 'maximize',
    ['CS 3005',
    'IT 1100', 'IT 1200', 'IT 2300', 'IT 2400', 'IT 2500', 'IT 2700',
    'IT 3100', 'IT 3110', 'IT 3150', 'IT 3300', 'IT 3400',
    'IT 4100', 'IT 4200', 'IT 4310', 'IT 4400', 'IT 4510', 'IT 4600',
...
db.make_section('CS 2420-01', ['stadium', 'flex:10', 'MWF 3×50 bell schedule'])
db.make_section('CS 3310-01', ['stadium', 'pcs', '3 credit bell schedule'])
db.make_section('CS 3600-01', ['pcs', 'stadium:10', '3 credit bell schedule'])
...
db.make_section('CS 3510-01', ['Smith 116', 'flex:1', '3 credit bell schedule', 'TR 2×75 bell schedule:10'])
db.make_section('CS 4320-01', ['Smith 116', 'flex:1', 'MWF 3×50 bell schedule:10', '2×75 bell schedule'])
db.make_section('CS 4600-01', ['Smith 116', 'flex:1', '3 credit bell schedule', 'TR 2×75 bell schedule:10'])
...
db.make_section('IT 3150-01', ['Smith 107', 'MW 2×75 bell schedule', 'MWF 3×50 bell schedule:5'])
...
db.make_section('SE 3200-01', ['Smith 107:5', 'flex', '3 credit bell schedule'])
...
db.add_anti_conflict(50, 'CS 4600-01', ['CS 4600-02'])
db.add_anti_conflict(50, 'CS 1030-01', ['CS 1400'])
#./edit add-anti-conflict 50 'SE 1400', 'IT 1100' # temporarily removed because of new hire planning

db.make_conflict('Computer Science', 'spread out CS 1400', 100, 'maximize',
    ['CS 1400-01', 'CS 1400-02', 'CS 1400-03', 'CS 1400-50'])
db.make_conflict('Computer Science', 'spread out CS 1410', 100, 'maximize',
    ['CS 1410-01', 'CS 1410-02'])
db.make_conflict('Computer Science', 'spread out CS 2450', 100, 'maximize',
    ['CS 2450-01', 'CS 2450-02'])
db.make_conflict('Computer Science', 'spread out CS 2810', 100, 'maximize',
    ['CS 2810-01', 'CS 2810-02'])
db.make_conflict('Information Technology', 'spread out IT 1100', 100, 'maximize',
    ['IT 1100-01', 'IT 1100-02'])
db.make_conflict('Information Technology', 'spread out IT 2300', 100, 'maximize',
