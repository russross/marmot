...
pub fn place(
    ...
    for elt in &undo.entries {
        if let &PlacementEntry::Remove(loser, RoomTimeWithPenalty { room: loser_room, time_slot: loser_time_slot, .. }) = elt {
            println!(
...
pub fn place_static(solver: &mut Solver) -> Result<(), String> {
    ...
    place(solver, "CS 1400-01", "Smith 116", "MWF0800+50")?;
    place(solver, "CS 1400-02", "Smith 108", "TR1330+75")?;
    place(solver, "CS 1400-03", "Smith 107", "MWF1000+50")?;
    place(solver, "CS 1400-50", "Smith 117", "T1800+150")?;
    place(solver, "CS 1410-01", "Smith 108", "MW1200+75")?;
    place(solver, "CS 1410-02", "Smith 108", "MWF0900+50")?;
    place(solver, "CS 2420-01", "Smith 108", "MWF1100+50")?;
    place(solver, "CS 2450-01", "Smith 109", "TR1500+75")?;
    place(solver, "CS 2450-02", "Smith 108", "TR1630+75")?;
    place(solver, "CS 2810-01", "Smith 109", "TR1200+75")?;
    ...
    place(solver, "CS 3310-01", "Smith 113", "MWF1000+50")?;
    place(solver, "CS 3410-01", "Smith 109", "TR1330+75")?;
    place(solver, "CS 3510-01", "Smith 116", "MWF1000+50")?;
    place(solver, "CS 3600-01", "Smith 116", "TR1030+75")?;
    place(solver, "CS 4307-01", "Smith 109", "MW1200+75")?;
    place(solver, "CS 4320-01", "Smith 108", "TR1200+75")?;
    place(solver, "CS 4550-01", "Smith 113", "MWF0900+50")?;
    ...
    place(solver, "IT 1100-01", "Smith 113", "TR1200+75")?;
    place(solver, "IT 1100-02", "Smith 113", "MW1200+75")?;
    place(solver, "IT 1200-01", "Smith 107", "TR1030+75")?;
    place(solver, "IT 2300-01", "Smith 107", "MWF0900+50")?;
    ...
    place(solver, "IT 3100-01", "Smith 107", "MWF1100+50")?;
    place(solver, "IT 3110-01", "Smith 108", "MWF0800+50")?;
    place(solver, "IT 3150-01", "Smith 107", "MW1200+75")?;
    place(solver, "IT 3400-01", "Smith 107", "MW1330+75")?;
    place(solver, "IT 4510-01", "Smith 108", "R1800+150")?;
    place(solver, "IT 4600-01", "Smith 108", "MWF1000+50")?;
    place(solver, "IT 4990-01", "Smith 107", "W1800+150")?;
    ...
    place(solver, "SE 3100-01", "Smith 108", "MW1630+75")?;
    place(solver, "SE 3200-01", "Smith 107", "TR0900+75")?;
    place(solver, "SE 3450-01", "Smith 112", "TR1200+75")?;
    place(solver, "SE 3500-01", "Smith 107", "TR1200+75")?;
    place(solver, "SE 3550-01", "Smith 112", "TR1030+75")?;
