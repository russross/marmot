...
def build_courses(db: queries.DB) -> None:
    ...
    db.make_department('Mathematics')
    ...
    db.make_course('Mathematics', 'MATH 0900', 'Transitional Math I')
    db.add_course_rotation('MATH 0900', 'fall')
    db.add_course_rotation('MATH 0900', 'spring')
    db.add_course_rotation('MATH 0900', 'summer')
    db.make_course('Mathematics', 'MATH 0980', 'Transitional Math IIB')
    db.add_course_rotation('MATH 0980', 'fall')
    db.add_course_rotation('MATH 0980', 'spring')
    db.add_course_rotation('MATH 0980', 'summer')
    db.make_course('Mathematics', 'MATH 1010', 'Intermediate Algebra')
    db.add_course_rotation('MATH 1010', 'fall')
    db.add_course_rotation('MATH 1010', 'spring')
    db.add_course_rotation('MATH 1010', 'summer')
    db.make_course('Mathematics', 'MATH 1020R', 'Bridge Into College Mathematics')
    db.add_course_rotation('MATH 1020R', 'summer')
    db.make_course('Mathematics', 'MATH 1030', 'Quantitative Reasoning (MA)')
    db.add_course_rotation('MATH 1030', 'fall')
    db.add_course_rotation('MATH 1030', 'spring')
    db.add_course_rotation('MATH 1030', 'summer')
    db.make_course('Mathematics', 'MATH 1040', 'Introduction to Statistics (MA)')
    db.add_course_rotation('MATH 1040', 'fall')
    db.add_course_rotation('MATH 1040', 'spring')
    db.add_course_rotation('MATH 1040', 'summer')
    db.make_course('Mathematics', 'MATH 1050', 'College Algebra / Pre-Calculus (MA)')
    db.add_course_rotation('MATH 1050', 'fall')
    db.add_course_rotation('MATH 1050', 'spring')
    db.add_course_rotation('MATH 1050', 'summer')
    db.make_course('Mathematics', 'MATH 1060', 'Trigonometry (MA)')
    db.add_course_rotation('MATH 1060', 'fall')
    db.add_course_rotation('MATH 1060', 'spring')
    db.add_course_rotation('MATH 1060', 'summer')
    db.make_course('Mathematics', 'MATH 1080', 'Pre-Calculus with Trigonometry (MA)')
    db.add_course_rotation('MATH 1080', 'fall')
    db.add_course_rotation('MATH 1080', 'spring')
    db.make_course('Mathematics', 'MATH 1100', 'Business Calculus (MA)')
    db.add_course_rotation('MATH 1100', 'fall')
    db.add_course_rotation('MATH 1100', 'spring')
    db.add_course_rotation('MATH 1100', 'summer')
    db.make_course('Mathematics', 'MATH 1210', 'Calculus I (MA)')
    db.add_course_rotation('MATH 1210', 'fall')
    db.add_course_rotation('MATH 1210', 'spring')
    db.make_course('Mathematics', 'MATH 1220', 'Calculus II (MA)')
    db.add_course_rotation('MATH 1220', 'fall')
    db.add_course_rotation('MATH 1220', 'spring')
    db.make_course('Mathematics', 'MATH 2010', 'Math for Elementary Teachers I')
    db.add_course_rotation('MATH 2010', 'fall')
    db.add_course_rotation('MATH 2010', 'spring')
    db.make_course('Mathematics', 'MATH 2020', 'Math for Elemen Teachers II')
    db.make_course('Mathematics', 'MATH 2050', 'Applied Statistics with Programming')
    db.add_course_rotation('MATH 2050', 'fall')
    db.make_course('Mathematics', 'MATH 2200', 'Discrete Mathematics')
    db.add_course_rotation('MATH 2200', 'spring')
    db.make_course('Mathematics', 'MATH 2210', 'Multivariable Calculus (MA)')
    db.add_course_rotation('MATH 2210', 'fall')
    db.add_course_rotation('MATH 2210', 'spring')
    db.make_course('Mathematics', 'MATH 2250', 'Differential Equations and Linear Algebra')
    db.add_course_rotation('MATH 2250', 'spring')
    db.make_course('Mathematics', 'MATH 2270', 'Linear Algebra')
    db.make_course('Mathematics', 'MATH 2280', 'Ordinary Differential Equations')
    db.make_course('Mathematics', 'MATH 2285', 'Adventures in Modeling')
    db.add_course_rotation('MATH 2285', 'fall')
    db.make_course('Mathematics', 'MATH 2905', 'Survey of Cryptography')
    db.make_course('Mathematics', 'MATH 3000', 'History of Mathematics')
    db.make_course('Mathematics', 'MATH 3010', 'Algebra for Secondary Mathematics Teaching')
    db.make_course('Mathematics', 'MATH 3020', 'Geometry and Statistics for Secondary Mathematics Teaching')
    db.make_course('Mathematics', 'MATH 3050', 'Stochastic Modeling and Applications')
    db.add_course_rotation('MATH 3050', 'spring')
    db.make_course('Mathematics', 'MATH 3060', 'Statistics for Scientists')
    db.add_course_rotation('MATH 3060', 'fall')
    db.add_course_rotation('MATH 3060', 'spring')
    db.make_course('Mathematics', 'MATH 3100', 'Euclidean / Non-Euclidean Geom')
    db.make_course('Mathematics', 'MATH 3120', 'Transition to Advanced Mathematics')
    db.add_course_rotation('MATH 3120', 'fall')
    db.make_course('Mathematics', 'MATH 3150', 'Introduction to Partial Differential Equations')
    db.make_course('Mathematics', 'MATH 3200', 'Introduction to Analysis I')
    db.add_course_rotation('MATH 3200', 'spring')
    db.make_course('Mathematics', 'MATH 3210', 'Introduction to Analysis II')
    db.make_course('Mathematics', 'MATH 3400', 'Probability & Statistics')
    db.add_course_rotation('MATH 3400', 'fall')
    db.make_course('Mathematics', 'MATH 3410', 'Actuarial Exam P/1 Preparation')
    db.add_course_rotation('MATH 3410', 'fall')
    db.make_course('Mathematics', 'MATH 3450', 'Statistical Inference')
    db.add_course_rotation('MATH 3450', 'spring')
    db.make_course('Mathematics', 'MATH 3500', 'Numerical Analysis')
    db.make_course('Mathematics', 'MATH 3605', 'Introduction to Modeling and Simulation')
    db.make_course('Mathematics', 'MATH 3700', 'Mathematical Modeling I')
    db.make_course('Mathematics', 'MATH 3900', 'Number Theory')
    db.make_course('Mathematics', 'MATH 3905', 'Cryptography and Codes')
    db.make_course('Mathematics', 'MATH 4000', 'Foundations of Algebra')
    db.add_course_rotation('MATH 4000', 'fall')
    db.make_course('Mathematics', 'MATH 4005', 'Quantum Computing and Cryptography')
    db.make_course('Mathematics', 'MATH 4010', 'Abstract Algebra II')
    db.make_course('Mathematics', 'MATH 4100', 'Introduction to Topology')
    db.make_course('Mathematics', 'MATH 4200', 'Introduction to Complex Analysis')
    db.make_course('Mathematics', 'MATH 4250', 'Programming for Scientific Computation')
    db.add_course_rotation('MATH 4250', 'spring')
    db.make_course('Mathematics', 'MATH 4330', 'Linear Algebra II')
    db.make_course('Mathematics', 'MATH 4400', 'Financial Mathematics')
    db.add_course_rotation('MATH 4400', 'spring')
    db.make_course('Mathematics', 'MATH 4410', 'Actuarial Exam FM/ 2 Preparation')
    db.add_course_rotation('MATH 4410', 'spring')
    db.make_course('Mathematics', 'MATH 4450', 'Math for Secondary Special Education Teachers')
    db.add_course_rotation('MATH 4450', 'fall')
    db.add_course_rotation('MATH 4450', 'spring')
    db.make_course('Mathematics', 'MATH 4500', 'Methods Teach Secondary Math')
    db.add_course_rotation('MATH 4500', 'fall')
    db.make_course('Mathematics', 'MATH 4550', 'Scientific Computation')
    db.make_course('Mathematics', 'MATH 4800', 'Industrial Careers in Mathematics')
    db.add_course_rotation('MATH 4800', 'spring')
    db.make_course('Mathematics', 'MATH 4890R', 'Independent Research')
    db.add_course_rotation('MATH 4890R', 'fall')
    db.add_course_rotation('MATH 4890R', 'spring')
    db.add_course_rotation('MATH 4890R', 'summer')
    db.make_course('Mathematics', 'MATH 4900', 'Senior Capstone Seminar (ALUR)')
    ...
    db.add_prereqs('IT 3510', ['IT 2400', 'IT 1500'])
